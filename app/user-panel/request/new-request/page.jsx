...
import UserSideBar from "@/components/modules/user-panel/userSideBar";
import {
  Card,
  CardHeader,
  CardTitle,
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 p-6 flex items-center justify-center min-h-screen">
        <Card className="max-w-xl w-full p-6 rounded-3xl shadow-2xl bg-gradient-to-br from-gray-50 to-white border border-gray-200">
          <CardHeader className="pb-2">
            <CardTitle className="text-2xl font-extrabold text-gray-800 flex items-center gap-3">
