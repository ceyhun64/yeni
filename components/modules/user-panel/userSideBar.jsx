...
export default function UserSideBar() {
  ...
  return (
    <Card className="w-64 min-h-screen border-r shadow-none bg-white dark:bg-zinc-950 flex flex-col justify-between">
      <div>
        {/* Üst Menü */}
        <h2 className="text-lg font-semibold ms-4 mb-2 text-zinc-900 dark:text-zinc-50">
          Kullanıcı Paneli
        </h2>
